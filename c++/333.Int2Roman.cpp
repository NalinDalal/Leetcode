...
public:
  string intToRoman(int num) {
    // create mapping for spcl symbols like {M,C,X,I,V,L}
    // subtract the value of symbols from input and append corrsponding into the
    // string ans
    // atlast return string ans
...
// sub:
// https://leetcode.com/problems/integer-to-roman/submissions/1591676240/?envType=study-plan-v2&envId=top-interview-150
// sol:
// https://leetcode.com/problems/integer-to-roman/solutions/6598547/12-integer-to-roman-by-nalindalal2004-k0zd/
