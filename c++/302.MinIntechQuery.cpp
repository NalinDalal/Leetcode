...
public:
  vector<int> minInterval(vector<vector<int>>& intervals,
                          vector<int>& queries) {
    // sort interval by range
    // for each range, select their queries, set value to (end-start+1)
...
// sub:
// https://leetcode.com/problems/minimum-interval-to-include-each-query/submissions/1574435089/
// sol:
// https://leetcode.com/problems/minimum-interval-to-include-each-query/solutions/6539110/1851-minimum-interval-to-include-each-qu-pfvn/
