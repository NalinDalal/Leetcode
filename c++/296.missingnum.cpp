...
// sort the array
// traverse it, if ith element +1 is not equal to i+1th element, then ith is
// missing

// optimisation:
// sum from 0 to n should be: n*(n+1)/2
// calculate this, then subtract from actual sum of elements
class Solution {
public:
...
// sub: https://leetcode.com/problems/missing-number/submissions/1570872360/
// sol:
// https://leetcode.com/problems/missing-number/solutions/6526404/268-missing-number-by-nalindalal2004-hpbp/
