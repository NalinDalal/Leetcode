...
// just simulate
// transaction fails if transfer>balance
// create a vector that stores all balances as per index
// if you want to transfer money, then the both accounts must be in range from 1
// to n `transfer()` return true if transaction is valid, updates the balances
//`deposit(int account, long money)` return true if account and money exists,
// also update the balance
//`withdraw(int account, long money)` return true account exists and money is
// less than balance
// else return false
...
// sub:
// https://leetcode.com/problems/simple-bank-system/submissions/1812356311/?envType=daily-question&envId=2025-10-26
// sol:
// https://leetcode.com/problems/simple-bank-system/solutions/7303230/2043-simple-bank-system-by-nalindalal200-x8av/
